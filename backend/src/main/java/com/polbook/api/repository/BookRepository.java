...
public interface BookRepository extends JpaRepository<Book, Long> {
        ...
        @Query("SELECT b FROM Book b JOIN FETCH b.location JOIN FETCH b.seller WHERE b.seller = :seller")
        Page<Book> findBySeller(@Param("seller") com.polbook.api.entity.User seller, Pageable pageable);
}
